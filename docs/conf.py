...
# Silence benign "more than one target found for cross-reference" noise. TVM
# re-exports common types (PrimExpr, Var, Any, Op) from several modules, so
# autodoc'd docstrings that mention them are inherently ambiguous to resolve.
