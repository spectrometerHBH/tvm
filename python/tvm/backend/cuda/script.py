...
class CUDANamespace:
    ...
    def __init__(self):
        ...
        self.copy_bytes_lds = _op_wrapper(_cuda_op.cuda_copy_bytes_lds)
        self.copy_128b_lds = _op_wrapper(_cuda_op.cuda_copy_128b_lds)
        self.copy_64b_lds = _op_wrapper(_cuda_op.cuda_copy_64b_lds)
        self.copy_32b_lds = _op_wrapper(_cuda_op.cuda_copy_32b_lds)
        self.copy_16b_lds = _op_wrapper(_cuda_op.cuda_copy_16b_lds)
        self.copy_8b_lds = _op_wrapper(_cuda_op.cuda_copy_8b_lds)
        self.copy_bytes_sts = _op_wrapper(_cuda_op.cuda_copy_bytes_sts)
        self.copy_128b_sts = _op_wrapper(_cuda_op.cuda_copy_128b_sts)
        self.copy_64b_sts = _op_wrapper(_cuda_op.cuda_copy_64b_sts)
        self.copy_32b_sts = _op_wrapper(_cuda_op.cuda_copy_32b_sts)
        self.copy_16b_sts = _op_wrapper(_cuda_op.cuda_copy_16b_sts)
        self.copy_8b_sts = _op_wrapper(_cuda_op.cuda_copy_8b_sts)
