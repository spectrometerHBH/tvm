...
const DeviceIntrinsicRegistration kDeviceIntrinsics[] = {
    ...
    TIRX_DEVICE_INTRIN_ALIAS(ptx_add_f32x2_val, ptx, kPure),
    ...
    TIRX_DEVICE_INTRIN_ALIAS(ptx_fma_f32x2_val, ptx, kPure),
    ...
    TIRX_DEVICE_INTRIN_ALIAS(ptx_mul_f32x2_val, ptx, kPure),
    ...
    TIRX_DEVICE_INTRIN_ALIAS(ptx_sub_f32x2_val, ptx, kPure),
